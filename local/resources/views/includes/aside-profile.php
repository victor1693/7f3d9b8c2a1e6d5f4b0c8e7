<div class="p-2" style="border-right:1px solid #2a2a2a;position: absolute;width: 260px;left: 0px;top: 0px;height: 100%;overflow-y: hidden;">
    <div class="card-body p-4 text-center" style="border-bottom: 1px solid #1d1d1d;">
        <span class="avatar avatar-xl mb-3 avatar-rounded" style="background-image: url(https://img-v2-prod.whop.com/P7zijbYXscmr8fmVmS7GZh2oLEwExSbeDofS6eTIs2Y/rs:fill:128:128/el:1/dpr:2/aHR0cHM6Ly9hc3NldHMud2hvcC5jb20vdXBsb2Fkcy8yMDI0LTA1LTI3L3VzZXJfMjk0MjMxMV81OWNkMGVlNy03OWMyLTRkZTctOGEwYi00NDk1MTYyMGFiYTguanBlZw)">
        </span>
        <h3 class="m-0 mb-0">
            <a class="mb-0" href="#">
                Paweł Kuna
